...
class WalletController extends Controller
{
    ...
    public function datatable()
    {
        ...
        $SQL="SELECT * FROM (SELECT * FROM wallet AS wallet_PARENT LEFT JOIN"
                ...
                ." LEFT JOIN (SELECT SUM(sumINCOME) AS sumINCOME, idWallet FROM ("
                    ." SELECT SUM(amount) AS sumINCOME, idWallet  FROM salary GROUP BY idWallet "
                    ." UNION ALL"
                    ." SELECT SUM(amount) AS sumINCOME, idWallet  FROM debt GROUP BY idWallet "
                    ." UNION ALL"
                    ." SELECT SUM(amount) AS sumINCOME, idWallet  FROM my_event GROUP BY idWallet "
                    ." ) AS TBCHILD"
                .") AS TBS "

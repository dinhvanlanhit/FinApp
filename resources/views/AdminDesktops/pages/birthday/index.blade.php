...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
              <table class="table table-bordered row-border hover" id="birthday-table"></table>
          </div>
        </div>
...
@include('AdminDesktops.pages.birthday.include')
@endsection
@section('javascript')
...
<script> 
    ...
    birthday.datas={
        routes:{
          datatable:"{{route('birthday_table')}}",
          insert:"{{route('birthday_insert')}}",
          update:"{{route('birthday_update')}}",
          delete:"{{route('birthday_delete')}}",
        }
    }   
    birthday.runJS();
</script>

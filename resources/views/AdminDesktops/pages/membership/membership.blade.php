...
<div class="card">
  ...
  <div class="card-body card-body-dashboard">
      ...
      <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered row-border hover text-small" id="membership-table"></table>
        </div>
      </div>
  </div>
  <!-- /.card-body -->
...
@include('AdminDesktops.pages.membership.include')
@endsection
@section('javascript')

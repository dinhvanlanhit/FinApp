			...
			<div class="modal-content">
				...
				<div class="modal-body card-body-dashboard">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="input-group mb-3">
									<div class="input-group-prepend"> <span class="input-group-text"> {{Auth::user()->idKey}}_</span>
									</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label>Mật Khẩu <small class="text-danger"><span id="text-password">(Không nhập mặt định là : 12345)</span></small>
								</label>
	...
	<div class="modal-dialog modal-lg" role="document">
			<form id="formPermission">
				<div class="modal-content">
					...
					<div class="modal-body card-body-dashboard" id="html-permission">

                    </div>
                    <div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal">Hủy</button>
						<button type="submit" class="btn btn-success"  id="onSavePermission">Lưu</button>
					</div>
                </div>
            </form>
    </div>

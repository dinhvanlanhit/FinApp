<nav class="main-header navbar navbar-expand navbar-dark navbar-danger">
	...
	<ul class="navbar-nav ">
		...
		</li>@if (Session::get('view_users')!=null) <a href="javascript:void(0)" class="nav-link active"><b> {{user()->full_name}}</b></a>
		@endif
    ...
    <li class="nav-item"> 
      <a href="javascript:void(0)" class="nav-link active" data-toggle="modal" class="dropdown-item" data-target="#modal-users">
        <b>
          <i class="fa fa-users d-sm-none"></i> <span class="d-none d-sm-inline-block"> <i class="fa fa-users"></i> Thành Viên</span>
        </b>
      </a>
    </li>
        ...
        <i class="fa fa-user-circle d-sm-none"></i>  <b class="d-none d-sm-inline-block">{{user()->full_name}} </b>
			</a>

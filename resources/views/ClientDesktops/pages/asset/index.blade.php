...
<div class="card">
    ...
    <div class="card-body card-body-dashboard">
        ...
        <div class="row">
          <div class="col-md-12">
              <table class="table table-bordered table-sm row-border hover text-small" id="asset-table"></table>
          </div>
        </div>
...
@include('ClientDesktops.pages.asset.include')
@endsection
@section('javascript')

<script src="{{asset('app/desktops/asset/asset.js')}}"></script>
<script> 
    var asset = new asset(); 
    asset.datas={
        routes:{
          datatable:"{{route('asset_table')}}",
          insert:"{{route('asset_insert')}}",
          update:"{{route('asset_update')}}",
          delete:"{{route('asset_delete')}}",
        }
    }   
    asset.runJS();
</script>

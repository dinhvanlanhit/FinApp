    ...
    <div class="section full mt-4">
        ...
        <div class="shadowfix carousel-small owl-carousel owl-theme">
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar2.jpg')}}" alt="img" class="imaged w-48">
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar3.jpg')}}" alt="img" class="imaged w-48">
                        <strong>Elwin</strong>
                    </div>
                </a>
            </div>
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar4.jpg')}}" alt="img" class="imaged w-48">
                        <strong>Alma</strong>
                    </div>
                </a>
            </div>
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar5.jpg')}}" alt="img" class="imaged w-48">
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar6.jpg')}}" alt="img" class="imaged w-48">
                        <strong>Maria</strong>
                    </div>
                </a>
            </div>
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar7.jpg')}}" alt="img" class="imaged w-48">
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar8.jpg')}}" alt="img" class="imaged w-48">
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar9.jpg')}}" alt="img" class="imaged w-48">
                        <strong>Alex</strong>
                    </div>
                </a>
            </div>
            ...
            <div class="item">
                <a href="#">
                    <div class="user-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/avatar/avatar10.jpg')}}" alt="img" class="imaged w-48">
                        <strong>Stina</strong>
                    </div>
                </a>
            </div>
        ...
        <div class="shadowfix carousel-multiple owl-carousel owl-theme">
            ...
            <div class="item">
                <a href="app-blog-post.html">
                    <div class="blog-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/photo/1.jpg')}}" alt="image" class="imaged w-100">
                        <div class="text">
            ...
            <div class="item">
                <a href="app-blog-post.html">
                    <div class="blog-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/photo/2.jpg')}}" alt="image" class="imaged w-100">
                        <div class="text">
            ...
            <div class="item">
                <a href="app-blog-post.html">
                    <div class="blog-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/photo/3.jpg')}}" alt="image" class="imaged w-100">
                        <div class="text">
            ...
            <div class="item">
                <a href="app-blog-post.html">
                    <div class="blog-card">
                        <img src="{{asset('AdminMobiles/assets/img/sample/photo/4.jpg')}}" alt="image" class="imaged w-100">
                        <div class="text">
